    ...
    <div class="pt-4 pb-4">
        <div class="card card-dark ">
                            ...
                            <tr>
                                ...
                                <td width="30%" >
                                    <div class="form-inline" >
                                        <a href="{{ route('cidade.show', $item->id)}}" class="btn ml-2 mr-2 btn-outline-primary">Mostrar</a>
                                        <a href="{{ route('cidade.edit', $item->id)}}" class="btn ml-2 mr-2 btn-outline-warning">Editar</a>
            ...
            <div class="card-footer">
                <a class="btn ml-2 mr-2 btn-outline-success" href="{{ route('cidade.create')}}">Criar</a>
            </div>
        </div>
    </div>
@stop
